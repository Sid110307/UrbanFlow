...
export interface SilkboardFloodHistoryPoint {
  id: string;
  name: string;
  position: Coordinate;
...
export interface SilkboardFloodHistoryDataset {
  metadata: {
    title: string;
    sourceName: string;
    sourceUrl: string;
  ...
  features: SilkboardFloodHistoryPoint[];
}

export interface SilkboardRealDrainDataset {
  type: "FeatureCollection";
  metadata: {
    title: string;
    sourceName: string;
