...
// Default failure-injection targets: the sensor_corrupt scenario corrupts this drain,
// the camera_offline scenario kills this camera, unless a scenario config overrides them.
export const DEFAULT_SENSOR_CORRUPT_DRAIN_ID = "BLR-SKB-103";
export const DEFAULT_CAMERA_OFFLINE_ID = "CAM-02";
...
export const SCENARIO_REFERENCES: SilkboardScenarioRef[] = [
  ...
  },
  {
    ...
    expected_agent_action: "Confirmed waterlogging zone: mark on map and camera confirmation",
  },
  {
    id: "SCN-05",
