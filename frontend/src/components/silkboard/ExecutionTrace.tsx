...
export function ExecutionTracePanel({
  ...
  // Identify currently selected trace
  ...
  // Selected gate within the trace for deep-dive inspection
  ...
  if (!traces || traces.length === 0) {
    return (
      <div className="exec-trace-empty">
        <div className="exec-trace-empty-icon">⚡</div>
    ...
    <div className="exec-trace-container">
              ...
              <div className="exec-trace-tab-sub">
                ...
                {isHealed && (
                  <span className="exec-trace-healed-pill" title="Self-healing recovery triggered">
                    🛡️ Healed ({trace.self_healing_count})
                  </span>
                )}
              </div>
            </button>
      ...
      {selectedTrace && (
        <div className="exec-trace-body">
              ...
              {selectedTrace.gates.map((gate, index) => {
                ...
                return (
                  <div key={gate.gate_id} className="exec-trace-step-item">
                    ...
                    >
                      <span className="gate-node-icon">{gate.gate_icon}</span>
          ...
          {/* ── Expanded Gate Inspector ── */}
          {activeGate && (
            <div className="exec-trace-inspector">
              <div className="inspector-header">
                <div className="inspector-title">
                  <span className="inspector-icon">{activeGate.gate_icon}</span>
                  <div>
                    <h5>
              ...
              {/* Self-healing recovery card if this gate executed recovery */}
              {activeGate.recovery && (
              ...
              {/* 15-Second Continuous Recording Chunk Telemetry */}
          ...
          {/* ── Bottom Trace Summary Bar ── */}
          <div className="exec-trace-summary-bar">
            <div className="summary-left">
              {selectedTrace.self_healing_count > 0 ? (
                <span className="summary-chip is-healed">
                  🛡️ {selectedTrace.self_healing_count} Self-Healing Event{selectedTrace.self_healing_count > 1 ? "s" : ""}
                </span>
              ) : (
