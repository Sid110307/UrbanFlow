...
export function GeminiConfigModal({
  ...
  const handleFetchModels = async () => {
    ...
    try {
      ...
      if (models.length > 0) {
        // If current model isn't in list, select first flash or first available
        ...
        <div className="gemini-modal-body">
          ...
          <div className="gemini-form-group">
            ...
            <small className="gemini-input-hint">
              Stored locally in your browser. If left empty, UrbanFlow seamlessly uses the deterministic 4-signal heuristic model.
            </small>
          </div>
